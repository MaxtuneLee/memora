...
const styles = stylex.create({
  ...
  heading: { color: tokens.textStrong, fontSize: 18, fontWeight: 650, margin: 0 },
  closeButton: {
    alignItems: "center",
  ...
  empty: { color: tokens.textMuted, fontSize: 14, gridColumn: "1 / -1" },
  card: {
  ...
  renameInput: {
    backgroundColor: tokens.surface,
    border: `1px solid ${tokens.oliveSoft}`,
    borderRadius: 8,
    color: tokens.text,
    flex: 1,
    fontSize: 14,
  ...
  confirm: {
    ...
    cursor: "pointer",
    ":hover": { backgroundColor: tokens.textStrong },
  },
});
