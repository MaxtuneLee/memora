...
const styles = stylex.create({
  ...
  label: { color: "var(--color-memora-text-muted)", fontSize: "0.75rem", fontWeight: 500 },
  sublabel: { color: "var(--color-memora-text-muted)", fontSize: "0.75rem" },
  workerList: { display: "flex", flexDirection: "column", gap: "0.5rem" },
  workerCard: {
    backgroundColor: "color-mix(in srgb,var(--color-memora-surface) 90%,white)",
  ...
  workerTitle: { color: "var(--color-memora-text-strong)", fontSize: "0.875rem", fontWeight: 600 },
  status: {
    borderRadius: "9999px",
  ...
  statusActive: { backgroundColor: "rgba(135,154,79,0.15)", color: "#516127" },
  statusIdle: { backgroundColor: "rgba(228,228,231,0.7)", color: "#52525b" },
  detailGrid: {
  ...
  subtle: { color: "var(--color-memora-text-subtle)" },
  ...
  residentMulti: { backgroundColor: "#fef3c7", color: "#b45309" },
  residentSingle: { backgroundColor: "#d1fae5", color: "#047857" },
  ...
  runtimeName: { color: "var(--color-memora-text-strong)", fontWeight: 500 },
  runtimeTime: {
    color: "var(--color-memora-text-subtle)",
    fontFamily: "monospace",
    fontSize: "0.625rem",
  },
  runtimeId: {
  ...
  empty: { color: "var(--color-memora-text-muted)", fontSize: "0.6875rem" },
  emptyWorkers: {
    backgroundColor: "color-mix(in srgb,var(--color-memora-surface) 75%,transparent)",
    borderColor: "var(--color-memora-border)",
    borderRadius: "1rem",
    borderStyle: "dashed",
    borderWidth: 1,
  ...
  widget: {
    ...
    backgroundColor: {
      default: "color-mix(in srgb,var(--color-memora-surface) 94%,white)",
      ":hover": "var(--color-memora-surface)",
    },
    borderColor: {
      default: "var(--color-memora-border)",
      ":hover": "var(--color-memora-olive-soft)",
    },
    borderStyle: "solid",
    borderWidth: 1,
    boxShadow: "0 18px 45px -30px rgba(34,33,29,0.35)",
  ...
  dragging: { cursor: "grabbing", boxShadow: "0 18px 45px -24px rgba(34,33,29,0.5)" },
  ...
  dotFrame: {
    alignItems: "center",
    backgroundColor: "color-mix(in srgb,var(--color-memora-olive) 16%,transparent)",
  ...
  panel: {
    backdropFilter: "blur(8px)",
    backgroundColor: "color-mix(in srgb,var(--color-memora-surface) 94%,white)",
    borderColor: "var(--color-memora-border)",
    borderRadius: "1.6rem",
    borderStyle: "solid",
    borderWidth: 1,
    boxShadow: "0 28px 80px -44px rgba(34,33,29,0.42)",
    display: "flex",
    flexDirection: "column",
    maxHeight: "100%",
    overflow: "hidden",
  ...
  countBadge: {
    backgroundColor: "color-mix(in srgb,var(--color-memora-olive) 14%,transparent)",
    borderRadius: "9999px",
    color: "var(--color-memora-olive)",
    flexShrink: 0,
    fontSize: "0.625rem",
  ...
  memoryValue: { color: "var(--color-memora-text-strong)", fontSize: "0.875rem", fontWeight: 600 },
});
