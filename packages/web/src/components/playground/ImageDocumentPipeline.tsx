...
const styles = stylex.create({
  ...
  imageFrame: {
    boxShadow: "0 14px 46px rgb(0 0 0 / 0.14)",
    maxHeight: "720px",
    maxWidth: "100%",
    overflow: "hidden",
    position: "relative",
  ...
  stageIcon: { color: tokens.olive, height: "0.875rem", width: "0.875rem" },
  stageDot: {
  ...
  stageName: { color: tokens.text, fontSize: "0.75rem", fontWeight: 600 },
  stageDetail: {
    color: tokens.textSoft,
    fontSize: "0.625rem",
    lineHeight: "1rem",
  ...
  progressLabel: { color: tokens.textMuted, fontWeight: 500 },
  progressValue: { color: tokens.textSoft },
  track: {
    backgroundColor: tokens.surface,
    borderRadius: "9999px",
    height: "0.375rem",
  ...
  metricLabel: { color: tokens.textSoft, fontSize: "0.6875rem", fontWeight: 500 },
  metricValue: {
    color: tokens.text,
    fontSize: "0.875rem",
    fontWeight: 600,
  ...
  inspectorTitle: { color: tokens.text, fontSize: "0.875rem", fontWeight: 600 },
  score: {
    backgroundColor: tokens.surfaceMuted,
    borderRadius: "9999px",
    color: tokens.textMuted,
