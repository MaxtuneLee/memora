...
const styles = stylex.create({
  ...
  icon16Olive: { color: tokens.olive, height: "1rem", width: "1rem" },
  title: {
  ...
  textarea: {
    ...
    borderColor: { default: tokens.border, ":focus": tokens.olive },
    ...
    ":focus": { boxShadow: `0 0 0 2px ${tokens.oliveSoft}` },
  },
  sectionHeader: {
    alignItems: "center",
    display: "flex",
  ...
  headingSmall: { color: tokens.text, fontSize: "0.875rem", fontWeight: 500 },
  soft12: { color: tokens.textSoft, fontSize: "0.75rem" },
  transcriptList: {
    backgroundColor: tokens.canvas,
    borderColor: tokens.border,
    borderRadius: "0.75rem",
  ...
  transcriptType: { color: tokens.textSoft, flexShrink: 0, fontSize: "0.75rem" },
  emptyTranscripts: {
    color: tokens.textMuted,
    fontSize: "0.875rem",
    lineHeight: "1.5rem",
  ...
  indexTitle: { color: tokens.text, fontSize: "0.75rem", fontWeight: 500 },
  body12: {
    color: tokens.textMuted,
    fontSize: "0.75rem",
    lineHeight: "1.25rem",
  ...
  chunkSource: { color: tokens.text, fontWeight: 500 },
  chunkMeta: {
    alignItems: "center",
    display: "flex",
    flexWrap: "wrap",
  ...
  sampleDataset: { color: tokens.text, fontWeight: 500 },
  separator: { color: tokens.textSoft, marginInline: "0.375rem" },
  benchmarkProgress: {
    backgroundColor: tokens.selected,
    borderRadius: "0.5rem",
    color: tokens.textMuted,
  ...
  score: {
    borderLeftColor: {
      default: "transparent",
      "@media (min-width: 1024px)": tokens.borderSoft,
    },
  ...
  scoreLabel: { color: tokens.textMuted, fontSize: "0.75rem", fontWeight: 500 },
  scoreValue: {
    color: tokens.textStrong,
    fontFamily: "monospace",
    fontSize: "1.5rem",
  ...
  reportMeta: { color: tokens.textSoft, fontSize: "0.75rem", marginTop: "0.75rem" },
  reportDetail: {
    color: tokens.textMuted,
    fontSize: "0.75rem",
    lineHeight: "1.25rem",
