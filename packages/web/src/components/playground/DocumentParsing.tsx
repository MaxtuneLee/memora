...
const styles = stylex.create({
  ...
  comparisonFirst: {
    borderRightColor: {
      default: "transparent",
      "@media (min-width: 768px)": "var(--color-memora-border)",
    },
    borderRightStyle: "solid",
    borderRightWidth: { default: 0, "@media (min-width: 768px)": 1 },
  },
  headingSmall: { color: "var(--color-memora-text)", fontSize: "0.875rem", fontWeight: 600 },
  softDescription: {
  ...
  metricLabel: { color: "var(--color-memora-text-soft)", fontSize: "0.6875rem" },
  metricValue: {
  ...
  sectionLabel: { color: "var(--color-memora-text-muted)", fontSize: "0.75rem", fontWeight: 500 },
  ...
  softText12: { color: "var(--color-memora-text-soft)", fontSize: "0.75rem" },
  softParagraph: {
    color: "var(--color-memora-text-soft)",
    fontSize: "0.75rem",
    lineHeight: "1.25rem",
  ...
  parsedTitle: { color: "var(--color-memora-text-muted)", fontSize: "0.75rem", fontWeight: 600 },
  preText: {
    color: "var(--color-memora-text-muted)",
    fontSize: "0.875rem",
    lineHeight: "1.75rem",
  ...
  icon14Olive: { color: "var(--color-memora-olive)", height: "0.875rem", width: "0.875rem" },
  ...
  fallbackText: { color: "var(--color-memora-text-soft)", fontSize: "0.875rem" },
  notice: {
    backgroundColor: "var(--color-memora-surface-soft)",
    borderColor: "var(--color-memora-border)",
    borderRadius: "1rem",
