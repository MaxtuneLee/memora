...
const styles = stylex.create({
  ...
  checkbox: { accentColor: tokens.olive, height: "1rem", width: "1rem" },
  ...
  exampleText: { color: tokens.text, fontSize: "0.875rem", lineHeight: "1.5rem" },
  exampleLabel: {
    color: tokens.textSoft,
    fontSize: "0.75rem",
    lineHeight: "1rem",
  ...
  oliveIcon: { color: tokens.olive, height: "1rem", width: "1rem" },
  emptyInstalled: {
