...
export default function SearchPalette() {
  ...
  return (
    <NativeDialog
      ...
      labelledBy={titleId}
      viewportClassName="items-start px-2 pt-[max(0.5rem,env(safe-area-inset-top))] sm:items-center sm:px-4 sm:pt-4"
      panelClassName="w-[min(760px,calc(100vw-1rem))] overflow-hidden rounded-[18px] border border-[#ddd8d0] bg-[rgba(255,255,253,0.98)] text-zinc-950 shadow-[0_18px_48px_rgba(38,34,29,0.12)] sm:w-[min(760px,92vw)]"
    >
      <div>
