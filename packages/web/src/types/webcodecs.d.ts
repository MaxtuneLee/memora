...
declare type WebCodecsHardwareAcceleration =
  | "no-preference"
  | "prefer-hardware"
  | "prefer-software";
...
declare class VideoEncoder {
  ...
  public isConfigSupported(): Promise<{
    supported?: boolean;
