...
export const desktopAllFilesQuery$ = queryDb(
  () => fileTable.orderBy("updatedAt", "desc"),
  {
    label: "desktop:files-all",
  },
);

export const desktopAllFoldersQuery$ = queryDb(
  () => folderTable.orderBy("updatedAt", "desc"),
  {
